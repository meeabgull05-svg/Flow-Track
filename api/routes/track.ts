...
// GET /api/track - Fetch all tracking records or filter by ?trackingId=... or ?status=...
...
// GET /api/track/:trackingId - Fetch single tracking record by ID
...
// PUT or PATCH /api/track/:trackingId - Update status and location
